...
EVENT_SCHEMAS: dict[str, EventSchema] = {
    ...
    "tool_end": EventSchema(
        ...
        fields=(
            ...
            EventFieldSpec("artifact_count", "integer", "Number of structured artifacts returned by the tool."),
            EventFieldSpec("artifacts", "list[object]", "Safe artifact summaries without inline data or private paths."),
            EventFieldSpec("result_metadata", "object", "Safe structured result metadata."),
            ...
            EventFieldSpec("temporary_grant_ttl_seconds", "integer", "Configured temporary grant TTL."),
            EventFieldSpec("tool_approval_mode", "string", "Tool approval mode from the related decision."),
            EventFieldSpec("requested_resources", "list[object]", "Resources requested by the related decision."),
            EventFieldSpec("display_name", "string", "User-facing tool label."),
            EventFieldSpec("execution_mode_label", "string", "User-facing execution mode label."),
            EventFieldSpec("risk_level", "string", "low/medium/high display risk."),
            EventFieldSpec("risk_summary", "string", "Short user-facing risk explanation."),
